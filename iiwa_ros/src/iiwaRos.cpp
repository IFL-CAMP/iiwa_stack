...
void iiwaRos::init(bool initRos) {
    ...
    cartesian_position_pub_ = node_handle.advertise<geometry_msgs::PoseStamped>("command/CartesianPosition",1);
    cartesian_rotation_pub_ = node_handle.advertise<iiwa_msgs::CartesianRotation>("command/CartesianRotation",1);
    cartesian_velocity_pub_ = node_handle.advertise<iiwa_msgs::CartesianVelocity>("command/CartesianVelocity",1);
    cartesian_wrench_pub_ = node_handle.advertise<geometry_msgs::WrenchStamped>("command/CartesianWrench",1);
    
    joint_position_pub_ = node_handle.advertise<iiwa_msgs::JointPosition>("command/JointPosition",1);
    joint_stiffness_pub_ = node_handle.advertise<iiwa_msgs::JointStiffness>("command/JointStiffness",1);
    joint_torque_pub_ = node_handle.advertise<iiwa_msgs::JointTorque>("command/JointTorque",1);
    joint_velocity_pub_ = node_handle.advertise<iiwa_msgs::JointVelocity>("command/JointVelocity",1);
    
    
    cartesian_position_sub_ = node_handle.subscribe("state/CartesianPosition", 1, &iiwaRos::cartesianPositionCallback, this);
    cartesian_rotation_sub_ = node_handle.subscribe("state/CartesianRotation", 1, &iiwaRos::cartesianRotationCallback, this);
    cartesian_velocity_sub_ = node_handle.subscribe("state/CartesianVelocity", 1, &iiwaRos::cartesianVelocityCallback, this);
    cartesian_wrench_sub_ = node_handle.subscribe("state/CartesianWrench", 1, &iiwaRos::cartesianWrenchCallback, this);
    
    joint_position_sub_ = node_handle.subscribe("state/JointPosition", 1, &iiwaRos::jointPositionCallback, this);
    joint_stiffness_sub_ = node_handle.subscribe("state/JointStiffness", 1, &iiwaRos::jointStiffnessCallback, this);
    joint_torque_sub_ = node_handle.subscribe("state/JointTorque", 1, &iiwaRos::jointTorqueCallback, this);
...
geometry_msgs::PoseStamped iiwaRos::getReceivedCartesianPosition() {
    new_cartesian_position_ = false;
    cp_mutex_.lock();
    geometry_msgs::PoseStamped cp = received_cartesian_position_;
    cp_mutex_.unlock();
    return cp;
}
...
geometry_msgs::WrenchStamped iiwaRos::getReceivedCartesianWrench(){
    new_cartesian_wrench_  = false;
    cw_mutex_.lock();
    geometry_msgs::WrenchStamped cw = received_cartesian_wrench_;
    cw_mutex_.unlock();
    return cw;
}
...
geometry_msgs::PoseStamped iiwaRos::getCommandCartesianPosition() {
 ...
 */
void iiwaRos::setCommandCartesianPosition(const geometry_msgs::PoseStamped& position) {
