...
void iiwaRosConn::init()
{
  ...
  cartesian_position_sub_ = node_handle.subscribe("/" + iiwaName +"/state/CartesianPosition", 1, &iiwaRosConn::cartesianPositionCallback, this);
  cartesian_rotation_sub_ = node_handle.subscribe("/" + iiwaName +"/state/CartesianRotation", 1, &iiwaRosConn::cartesianRotationCallback, this);
  cartesian_velocity_sub_ = node_handle.subscribe("/" + iiwaName +"/state/CartesianVelocity", 1, &iiwaRosConn::cartesianVelocityCallback, this);
  cartesian_wrench_sub_ = node_handle.subscribe("/" + iiwaName +"/state/CartesianWrench", 1, &iiwaRosConn::cartesianWrenchCallback, this);
  
  joint_position_sub_ = node_handle.subscribe("/" + iiwaName +"/state/JointPosition", 1, &iiwaRosConn::jointPositionCallback, this);
  joint_torque_sub_ = node_handle.subscribe("/" + iiwaName +"/state/JointTorque", 1, &iiwaRosConn::jointTorqueCallback, this);
  joint_velocity_sub_ = node_handle.subscribe("/" + iiwaName +"/state/JointVelocity", 1, &iiwaRosConn::jointVelocityCallback, this);
}
